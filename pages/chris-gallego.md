...
Most of what I do professionally happens behind a client's NDA. This project doesn't have one. I wanted a place where the process is as visible as the output: the pipeline is open source, the content is markdown files in a public repo, and the [build story](/how-this-works) is written the way it actually happened, mistakes included. There are several. I left them in.

## Where else to find me

- [GitHub: @crgallego](https://github.com/crgallego) — the source for this entire site
- [Open an issue](https://github.com/crgallego/aicreatordigest/issues/new) if you're a creator featured here, or if something's wrong

I'd rather publish a short, true bio than a padded one. This one took a correction to get there.
